...
掏出手机，微信扫一扫即可开局！无需下载安装，支持单机切磋与好友联机对战：

![牛头王 6 Nimmt! 微信小程序](img.png)

- 🎯 **单机模式** — 与 5 个规则 AI 对战，随时随地磨练牌技
- 🌐 **多人联机** — 创建房间或输入 6 位房间号，与好友实时对战（支持人类 + AI 混合房间，最少 1 人即可开局）
- 🃏 **逐张出牌动画** — 牌一张张飞入牌桌，还原真实桌游手感
- ⚡ **长轮询同步** — 基于 PHP Long Polling 的伪实时通信，兼容老版本服务器
